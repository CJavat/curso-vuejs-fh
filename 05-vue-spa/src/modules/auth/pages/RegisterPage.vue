<template>
  ...
  <form action="#" method="POST">
    ...
    <div class="mb-4">
      ...
      <input type="text" id="fullname" name="fullname" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" autocomplete="off">
    </div>
    <!-- Username Input -->
    <div class="mb-4">
