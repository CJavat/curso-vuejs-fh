import { getProducts, getProductsAction } from '../../products/actions/get-products.actions';
<template>
  <!-- Title -->
...
import { getProductsAction } from '@/modules/products/actions/get-products.actions';
